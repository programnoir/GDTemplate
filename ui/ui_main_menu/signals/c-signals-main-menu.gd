...
func _on_ui_button_new_pressed():
	owner.emit_signal( "menu_new_game", owner.room_game_start )


#	Opens the settings menu.
func _on_ui_button_settings_pressed() -> void:
	owner.focus_button = owner.nUIButtonSettings
	owner.visible = false
...
func _on_ui_button_settings_visibility_changed() -> void:
